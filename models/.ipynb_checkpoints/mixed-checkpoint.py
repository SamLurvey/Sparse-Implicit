...
class AlternatingRegressor(nn.Module):
    def __init__(self, in_features, hidden_features, hidden_layers, out_features, outermost_linear=True):
        ...
        # First layer is always Sine
        self.net.append(SineLayer(in_features, hidden_features, is_first=True, omega_0=first_omega_0))
        
        for i in range(hidden_layers-1):
            if i % 2 == 0:
                self.net.append(GaussianLayer(hidden_features, hidden_features, sigma=sigma))
            else:
        ...
        if outermost_linear:
            ...
            # Last hidden layer is opposite of the previous one
            if (hidden_layers - 1) % 2 == 0:
                self.net.append(SineLayer(hidden_features, out_features, is_first=False, omega_0=hidden_omega_0))
            else:
                self.net.append(GaussianLayer(hidden_features, out_features, sigma=sigma))
...
class AlternatingModel:
    def __init__(self, params):
        ...
        self.model = AlternatingRegressor(
